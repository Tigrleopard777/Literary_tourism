...
namespace Literary_tourism.Controllers
{
    ...
    [ApiController]
    public class MarkOfWorkController : ControllerBase
    {
        private readonly LiteraryTourismContext db;

        public MarkOfWorkController(LiteraryTourismContext context)
        {
            db = context;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> PostMark([FromBody] Mark_of_work mark)
        {
            ...
            //{
                ...
                var mark_ = (from Mark in db.Set<Mark_of_work>()
                             where Mark.Id_work.Equals(mark.Id_work) &&
